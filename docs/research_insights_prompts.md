...
Save each investigation question and its answer (and include any other relevant information like the final query(s) or script used to answer the question if it is not obvious from the question itself) in a new file analysis_output/GD4/research/GD4_investigation_answers.md as you go. Refer to the GD4_claude_research_guide.md for formatting this answers document.
